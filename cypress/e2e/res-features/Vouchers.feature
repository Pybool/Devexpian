Feature: Ensure that vouchers can be purchased
    ...
    Scenario: On Reservations environment i ensure that vouchers can be purchased for 1 year no month rounding
        ...
        Then I click the "Vouchers" subtab to buy a new "Voucher"
        Then I select a "voucher" for purchase for "1 year without rounding"
    ...
    @automated @functional
    Scenario: On Reservations environment i ensure that vouchers can be purchased for 1 year with month rounding
        When I navigate to the "login" page on the selected environment
        Then I login using valid "<username>" and "<password>"
        Then I click on the "New Order" button on the landing page
        Then I use "Place Order On Behalf" feature to purchase entitlement for "taye.oyelekan@expian.io"
        ...
        Then I should see subtabs "Memberships", "Patronages" and "Vouchers" displayed
        Then I click the "Vouchers" subtab to buy a new "Voucher"
        Then I select a "voucher" for purchase for "1 year with rounding"
        Then The Add To Cart button should be visible
        Then I click Add To Cart button after the spinner disappears
        Then I click the "Checkout" button
        Then I fill in the customer general information
    ...
    @automated @functional
    Scenario: On Reservations environment i ensure that voucher can be purchased for 1 month no month rounding
        When I navigate to the "login" page on the selected environment
        Then I login using valid "<username>" and "<password>"
        Then I click on the "New Order" button on the landing page
        Then I use "Place Order On Behalf" feature to purchase entitlement for "taye.oyelekan@expian.io"
        ...
        Then I should see subtabs "Memberships", "Patronages" and "Vouchers" displayed
        Then I click the "Vouchers" subtab to buy a new "Voucher"
        Then I select a "voucher" for purchase for "1 month without rounding"
        Then The Add To Cart button should be visible
        Then I click Add To Cart button after the spinner disappears
        Then I click the "Checkout" button
        Then I fill in the customer general information
    ...
    @automated @functional
    Scenario: On Reservations environment i ensure that vouchers can be purchased for 1 month with month rounding
        When I navigate to the "login" page on the selected environment
        Then I login using valid "<username>" and "<password>"
        Then I click on the "New Order" button on the landing page
        Then I use "Place Order On Behalf" feature to purchase entitlement for "taye.oyelekan@expian.io"
        ...
        Then I should see subtabs "Memberships", "Patronages" and "Vouchers" displayed
        Then I click the "Vouchers" subtab to buy a new "Voucher"
        Then I select a "voucher" for purchase for "1 month with rounding"
        Then The Add To Cart button should be visible
        Then I click Add To Cart button after the spinner disappears
        Then I click the "Checkout" button
        Then I fill in the customer general information
